...
use App\Models\AdjectiveDatatable;
...
class AdjectiveDatatables extends DataTable
{

    private $crudName = 'adjectives';
     ...
     *
     * @param \App\Models\AdjectiveDatatable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Adjective $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('adjectivedatatables-table')
    ...
    {
        return 'AdjectiveDatatables_' . date('YmdHis');
    }
}
