...
use App\Models\BranchDatatable;
...
class BranchDatatables extends DataTable
{
     ...
     *
     * @param \App\Models\BranchDatatable $model
    ...
    {
        return $this->builder()
                    ->setTableId('branchdatatables-table')
    ...
    {
        return 'BranchDatatables_' . date('YmdHis');
    }
}
