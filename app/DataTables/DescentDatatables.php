...
use App\Models\DescentDatatable;
...
class DescentDatatables extends DataTable
{

    private $crudName = 'descents';
     ...
     *
     * @param \App\Models\DescentDatatable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Descent $model)
    {
        return $model->newQuery();
    }
    public function count()
    {
        return Descent::all()->count();
    }
    ...
    {
        return $this->builder()
                    ->setTableId('descentdatatables-table')
    ...
    {
        return 'DescentDatatables_' . date('YmdHis');
    }
}
