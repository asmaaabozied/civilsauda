                        ...
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title"> @lang('site.jobs')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Job::count()}}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">@lang('site.citizens')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Citizen::count()}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="progress progress-sm mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">@lang('site.operations')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Operation::count()}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="progress progress-sm mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title"> @lang('site.cards')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Card::count()}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="progress progress-sm mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">@lang('site.finances')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Finance::count()}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="progress progress-sm mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">@lang('site.tripes')</div>
                                    <div class="dash-counts">
                                        <p>{{\App\Models\Tribe::count()}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="progress progress-sm mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dash-widget-header">
                                ...
                                <div class="dash-count">
                                    <div class="dash-title">@lang('site.branches')</div>
                                    <div class="dash-counts">
