                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.finances.store') }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="operation_id" class="form-control select2">
                                                ...
                                                @foreach ($Operations as $key=>$citizen)
                                                    <option
                                                        value="{{$citizen->id}}" >
                                                        {{ $citizen->name_ar}}
                                                    </option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control select2">
                                                <option value="">@lang('site.select')</option>
                                                <option value="ACCEPTABLE">@lang('site.ACCEPTABLE')</option>
                                                <option value="REJECTED">@lang('site.REJECTED')</option>
                                                <option value="REVISION">@lang('site.REVISION')</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_type" class="form-control select2">
                                                ...
                                                <option value="NO_PAID">@lang('site.NO_PAID')</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="operation_type" class="form-control select2">
                                                <option value="">@lang('site.select')</option>
                                                <option value="WITHDRAW">@lang('site.WITHDRAW')</option>
                                                <option value="DEPOSIT">@lang('site.DEPOSIT')</option>
