                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard.branches.update', $city->id) }}"
                                  method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description_ar" class="form-control"
                                                   value="{{$city->description_ar}}">
                                        </div>
                                        <div class="form-group">
                                            <label>@lang('site.description_en')</label>
                                            <input type="text" name="description_en" class="form-control"
                                                   value="{{$city->description_en}}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" class="form-control" value="{{$city->phone}}">
                                        </div>
